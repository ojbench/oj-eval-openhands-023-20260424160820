...
def main():
    ...
    submit_parser.add_argument("--code-file", type=str,
                               help="Path to the source code file (required for non-git submissions)")
    submit_parser.add_argument("--git-url", type=str,
                               help="Git repository URL (required for git submissions)")
